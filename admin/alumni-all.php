                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                         <?php
                                                ...
                                                $ds=new dataservice();
                                                $res=$ds->fetch_query("select * from alumni,course,department where course.couId=alumni.aluCouId and department.depId=alumni.aluDepId and aluStatus='YES'"); 
                                                ...
                                                while($row=mysqli_fetch_assoc($res))
                                                {
                                                    echo '<tr><td><img src='.$row["aluImg"].' width="50px"/></td>
                                                           ...
                                                           <td>'.$row["couName"].'</td>
                                                            ...
                                                            <td>'.$row["aluPhone"].'</td>
                                                             <td><a href="'.$row["aluResume"].'" target="_BLANK">Download</a></td>
                                                            
                                                           <td><a href="alumni-all.php?del='.$row["aluId"].'">Delete</a></td>
                                                           </tr>';
