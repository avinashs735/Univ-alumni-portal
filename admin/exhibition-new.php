                                ...
                                <div class="col-md-6">
                                    ...
                                    <form role="form" action="server.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="sdate" placeholder="Enter Start Date" />
                                        </div>
                                         <div class="form-group">
                                            <label>End Date</label>
                                            <input class="form-control" name="edate" placeholder="Enter End Date" />
                                        </div>
                                         <div class="form-group">
                                            <label>Description</label>
                                            <textarea class="form-control" placeholder="Enter Description" name="desc"></textarea>
                                        </div>
                                         <div class="form-group">
                                            <label>Type</label>
                                        ...
                                        <input type="hidden" name="action" value="EXHI">
