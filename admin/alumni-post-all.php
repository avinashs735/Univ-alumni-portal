<?php
 ...
 {
     $ds=new dataservice();
     $res=$ds->delete_data("delete from memory_lane where memId=".$_REQUEST['del']."");
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                         <?php
                                                ...
                                                {
                                                    echo '<tr> <td><img src='.$row["memImg"].' width="50px"/></td>
                                                           
                                                             <td>'.$row["memDesc"].'</td>
                                                              <td>'.$row["aluName"].'</td>
                                                             <td>'.$row["aluBatch"].'</td>
                                                            <td>'.$row["memDate_Time"].'</td>
                                                                                          
                                                           <td><a href="alumni-post-all.php?del='.$row["memId"].'">Delete</a></td>
                                                           </tr>';
